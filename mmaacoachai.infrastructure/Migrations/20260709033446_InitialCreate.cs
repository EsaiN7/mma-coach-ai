...
namespace mmacoachai.infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoachNotes = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SkillRatings_Athletes_AthleteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillRatings_AthleteId",
                table: "SkillRatings",
                column: "AthleteId");
